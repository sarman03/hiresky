...
export default function ThemeToggle() {
  ...
  const toggle = () => {
    ...
    try {
      localStorage.setItem("hiresky-theme", next);
    } catch {
  ...
  return (
    <button
      ...
      className="glass fixed right-6 bottom-6 z-50 flex h-11 w-11 items-center justify-center rounded-full text-text transition-colors hover:border-text-dim"
    >
      {theme === "dark" ? (
        <svg
          viewBox="0 0 24 24"
